...
autoconf
%configure --enable-scp-compat --enable-chrooted-binary --enable-bbcp-compat --enable-rsync-compat 
...
* Mon Sep 05 2016 Benjamin Lefoul <lef@fedoraproject.org> - 4.8-18
- Re-enable rsync compatibility, BZ 1361475.

* Fri Jul 08 2016 Benjamin Lefoul <lef@fedoraproject.org> - 4.8-17
- Include scponly in /etc/shells.
...
- Converted spec file to use Git repo: https://github.com/scponly/scponly
- Added bbcp support: https://lists.ccs.neu.edu/pipermail/scponly/2009-May/002079.html

* Tue Oct 14 2014 David Brown <david.brown@pnnl.gov> 4.8-15
...
* Sat Apr 13 2013 Jon Ciesla <limburgher@gmail.com> - 4.8-11
